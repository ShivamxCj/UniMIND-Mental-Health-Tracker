...
import { getGAD7Questions, submitTest } from '../services/api'
...
const GAD7Test = () => {
  ...
  const loadQuestions = async () => {
    try {
      const response = await getGAD7Questions()
  ...
  if (result) {
    ...
    const isCriticalCondition = result.score === 21;
      ...
      <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="text-red-700 mt-1">
                  Your score indicates severe anxiety symptoms. It's important to seek professional help immediately.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className={`rounded-lg p-4 mb-4 ${
            ...
            <p className="text-lg font-semibold">Score: {result.score}/21</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="prose prose-sm">
            {result.severity_level === 'minimal' && (
              <p>Your score suggests minimal anxiety symptoms. Continuing with regular self-care practices is recommended.</p>
            )}
            {result.severity_level === 'mild' && (
              <p>Your score suggests mild anxiety symptoms. Consider incorporating some of the recommended resources into your routine.</p>
            )}
            {result.severity_level === 'moderate' && (
              <p>Your score suggests moderate anxiety symptoms. We recommend exploring the suggested resources and considering professional support.</p>
            )}
            {result.severity_level === 'severe' && (
              <div>
                <p className="font-medium text-red-700">
                  Your score suggests significant anxiety symptoms. We strongly recommend seeking professional support as soon as possible.
                </p>
                {isCriticalCondition && (
                  <div className="mt-3 p-3 bg-red-50 rounded-lg">
                    <p className="text-red-800 text-sm">
                      <strong>Maximum score detected:</strong> Your responses indicate you're experiencing the most severe level of anxiety symptoms. 
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">GAD-7 Anxiety Test</h2>
